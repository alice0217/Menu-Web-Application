...
restaurant1 = Restaurant(name="Urban Burger", background="r.png")
...
restaurant2 = Restaurant(name="Super Stir Fry", background="r.png")
...
restaurant1 = Restaurant(name="Panda Garden", background="r.png")
...
restaurant1 = Restaurant(name="Thyme for That Vegetarian Cuisine ", background="r.png")
...
restaurant1 = Restaurant(name="Tony\'s Bistro ", background="r.png")
...
# Menu for Andala's
restaurant1 = Restaurant(name="Andala\'s", background="r.png")
...
restaurant1 = Restaurant(name="Auntie Ann\'s Diner ", background="r.png")
...
restaurant1 = Restaurant(name="Cocina Y Amor ", background="r.png")
...
restaurant1 = Restaurant(name="State Bird Provisions", background="r.png")
session.add(restaurant1)
session.commit()
